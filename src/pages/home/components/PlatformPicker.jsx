...
import { Grid, TextField, Button, Stack, Typography, Autocomplete, Paper } from "@mui/material"
...
export default function PlatformPicker() {
  ...
  return (
    <Grid container direction="row" justifyContent="center" alignItems="center" sx={{ marginLeft: "1rem" }}>
      <Grid item xs={12}>
